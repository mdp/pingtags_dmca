...
Rails::Initializer.run do |config|
  ...
  FakeWeb.register_uri(:get, "https://api.linkedin.com/v1/people/~:(id,first-name,last-name,industry,headline,picture-url)", :body => File.read(RAILS_ROOT + 'spec/fixtures/profile.xml'))
end