...
When /^I return to PingTags$/ do
  ...
  stub_get("https://api.linkedin.com/v1/people/~:(id,first-name,last-name,industry,headline,summary,picture-url,location,member-url-resources)", 'profile.xml')
  visit oauth_callback_path(:oauth_verify => 'foo')
end
